<template>
    <div class="security-status-indicator">
        <v-card class="pa-3 mb-4" :color="statusColor" variant="tonal" border>
            <div class="d-flex align-center">
                <v-icon :icon="statusIcon" :color="statusColor" size="24" class="mr-3" />
                ...
                <v-btn v-if="showRefresh" icon="mdi-refresh" variant="text" size="small" @click="checkSecurity"
                    :loading="checking" />
            </div>
                ...
                <div v-show="showDetails" class="mt-3">
                    ...
                    <div class="security-details">
                        <div class="d-flex justify-space-between align-center mb-2">
                            ...
                            <v-chip :color="sessionStatus.color" size="small" variant="flat">
                                {{ sessionStatus.text }}
                            </v-chip>
                        </div>
                        <div class="d-flex justify-space-between align-center mb-2">
                            <span class="text-body-2">Connection:</span>
                            <v-chip :color="connectionStatus.color" size="small" variant="flat">
